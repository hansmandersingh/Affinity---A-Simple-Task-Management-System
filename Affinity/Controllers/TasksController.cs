...
namespace Affinity.Controllers
{
    public class TasksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,TaskContent,Time,CompletedPercentage,ProjectId,UserId,Priority")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,TaskContent,Time,CompletedPercentage,ProjectId,UserId,Priority")] Task task)
        {
            if (ModelState.IsValid)
            {
